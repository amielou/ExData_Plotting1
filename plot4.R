...
par(mfrow=c(2,2))
par(mar=c(4, 4, 2, 2))
plot(as.numeric(mySubset$Global_active_power) ~ as.POSIXct(mySubset$DateTime),ylab="Global Active Power (kilowatts)", xlab="", type="l")

plot(as.numeric(mySubset$Voltage) ~ as.POSIXct(mySubset$DateTime),ylab="voltage", xlab="datetime", type="l")

plot(as.POSIXct(mySubset$DateTime), mySubset$Sub_metering_1, xlab="", ylab="Energy sub metering", type="l")
...
plot(as.numeric(mySubset$Global_reactive_power) ~ as.POSIXct(mySubset$DateTime),ylab="Global Reactive Power", xlab="datetime", type="l")
